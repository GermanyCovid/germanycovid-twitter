    ...
    export function createVaccinationsImage(): Promise<Buffer> {
        return new Promise((resolve, reject) => {
            ...
            Promise.all([
                ...
                try {
                    image.setElement(numberFormat.format(data.current.data.administeredVaccinations), "", 960, 540, true);
                    image.setElement(numberFormat.format(data.current.data.vaccinated), "+ ~" + numberFormat.format(data.current.data.delta) + " | " + numberFormat.format(Number((data.current.data.quote * 100).toFixed(1))) + "%", 265, 825);
                    image.setElement(numberFormat.format(data.current.data.secondVaccination.vaccinated), "+ ~" + numberFormat.format(data.current.data.secondVaccination.delta) + " | " + numberFormat.format(Number((data.current.data.secondVaccination.quote * 100).toFixed(1))) + "%", 730, 825);
                    image.setElement(numberFormat.format(data.current.data.boosterVaccination.vaccinated), "+ ~" + numberFormat.format(data.current.data.boosterVaccination.delta) + " | " + numberFormat.format(Number((data.current.data.boosterVaccination.quote * 100).toFixed(1))) + "%", 1195, 825);
                    image.setElement(numberFormat.format(data.current.data["2ndBoosterVaccination"].vaccinated), "+ ~" + numberFormat.format(data.current.data["2ndBoosterVaccination"].delta) + " | " + numberFormat.format(Number((data.current.data["2ndBoosterVaccination"].quote * 100).toFixed(1))) + "%", 1660, 825);
                } catch (err) {
                    return reject();
                }
